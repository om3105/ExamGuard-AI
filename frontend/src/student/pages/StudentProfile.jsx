...
const StudentProfile = () => {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm text-slate-500 font-medium tracking-wide">Loading profile...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 text-gray-900 font-sans">
                    ...
                    <div className="flex justify-between h-16">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div
                                ...
                                className="h-10 w-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm border-2 border-white shadow-md cursor-pointer hover:shadow-lg hover:scale-105 transition-all"
                                title="View Profile"
                            >
                                {initials}
                            </div>
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-16 relative z-10">
                ...
                {successMsg && (
                    <div className="mb-5 bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex items-center gap-3 shadow-sm animate-[fadeIn_0.3s_ease]">
                        ...
                        <p className="text-sm text-emerald-700 font-medium flex-1">{successMsg}</p>
                    </div>
                )}
                ...
                <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                    ...
                    {/* ─── Profile Header ─── */}
                    <div className="relative bg-gradient-to-r from-slate-50 to-blue-50/50 px-8 py-8 border-b border-gray-100">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            {/* Avatar */}
                            <div className="relative group">
                                <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-violet-600 flex items-center justify-center text-white font-bold text-3xl shadow-lg shadow-blue-500/25">
                                    {initials}
                                </div>
                                <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-emerald-400 border-2 border-white shadow-sm"></div>
                            </div>
                            {/* Info */}
                            <div className="flex-1">
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    ...
                                    {profile?.college && (
                                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-violet-50 text-violet-700 text-xs font-semibold rounded-full border border-violet-100">
                                            {profile.college}
                                        </span>
                                    )}
                                </div>
                    ...
                    {!isEditing ? (
                        ...
                        <form onSubmit={handleSave} className="p-8">
                            ...
                            <div className="mt-8 flex flex-col-reverse sm:flex-row gap-3 sm:justify-end">
                                ...
                                <button type="submit" disabled={saving} className="px-8 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-600/20 hover:shadow-blue-600/30 transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                                    {saving ? (
                                        <>
...
const ProfileField = ({ label, value, icon }) => (
    <div className="group flex items-start gap-3 p-3.5 rounded-xl hover:bg-slate-50 transition-colors -mx-3.5">
