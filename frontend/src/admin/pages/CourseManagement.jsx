                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-8">
                                            ...
                                            <div className="pl-4 space-y-2 border-l-2 border-gray-100">
                                                {mod.lessons.map((les, lIdx) => (
                                                    <div key={lIdx} className="flex items-center gap-2 text-sm bg-gray-50 p-2 rounded">
                                                        ...
                                                        {les.quiz_id && <span className="text-xs bg-indigo-100 text-indigo-700 px-2 rounded-full font-bold ml-auto border border-indigo-200">Attached Quiz</span>}
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                            ...
                            <section className="border border-indigo-100 rounded-lg overflow-hidden shadow-sm">
                                <div className="bg-indigo-50 px-4 py-3 border-b border-indigo-100">
                                    <h3 className="font-bold text-indigo-900 flex items-center gap-2"><Plus className="w-4 h-4" /> Add New Module</h3>
                                </div>
                                <div className="p-4 space-y-4 bg-white">
                                        ...
                                        {currentModule.lessons.length > 0 && (
                                            <div className="mt-3 text-xs text-gray-500 flex gap-2 flex-wrap">
                                                {currentModule.lessons.map((l, i) => (
                                                    <span key={i} className="bg-indigo-100 text-indigo-800 px-2 py-1 rounded font-medium border border-indigo-200">
                                                        {l.title}
                                                    </span>
                                                ))}
                                            </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full font-bold bg-indigo-600 text-white hover:bg-indigo-700 px-4 py-2 rounded-lg transition-colors mt-2"
                                    >
