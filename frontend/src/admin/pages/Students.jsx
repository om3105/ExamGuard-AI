                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4 mt-2 text-sm text-gray-600">
                                            ...
                                            <span className="flex items-center gap-1.5"><Calendar className="w-4 h-4 text-gray-400" />Joined {new Date(selectedStudent.created_at).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })}</span>
                                        </div>
                                            ...
                                            {studentExams.map((exam) => (
                                                <tr key={exam.id} className="hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-500">
                                                        {new Date(exam.submitted_at).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })}
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-4 bg-white px-5 py-3 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900 leading-none mt-1">{students.length}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex gap-4 mb-6">
                <div className="relative flex-1 max-w-md">
                    ...
                    <input
                        ...
                        className="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-lg leading-5 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm"
                    />
                </div>
            </div>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                <div className="flex-shrink-0 h-10 w-10">
                                                    <div className="h-10 w-10 rounded-lg bg-blue-50 text-blue-700 flex items-center justify-center font-bold text-lg border border-blue-200">
