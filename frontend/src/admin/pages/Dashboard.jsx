                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-3 text-xs text-gray-500">
                                                        <div className="flex items-center gap-1">
                                                            ...
                                                            <span>
                                                                {new Date(exam.start_time).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })}
                                                            </span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                ...
                                {stats.recent_submissions.slice(0, 5).map((submission) => (
                                    <div key={submission.id} className="p-4 hover:bg-gray-50 transition-colors">
                                        ...
                                        <div className="flex justify-between items-center text-xs text-gray-500 mt-2">
                                            ...
                                            <span>{new Date(submission.submitted_at).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' })}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
