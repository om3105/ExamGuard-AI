...
import { LANGUAGE_OPTIONS } from '../../services/judge0';
        ...
        <div>
            <div className="bg-white rounded-lg shadow-sm border p-4 mb-6">
                ...
                <button
                    ...
                    disabled={isRunning}
                    className="mt-3 px-6 py-2 bg-indigo-600 text-white font-semibold rounded hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors focus:ring-2 focus:ring-indigo-400 focus:outline-none"
                >
                            ...
                            >
                                ...
                                <div className="text-xs space-y-1 font-mono">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-gray-900">{result.actual || 'No output'}</span>
                                    </div>
                                    {result.error && (
