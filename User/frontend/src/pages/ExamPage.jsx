...
const ExamPage = () => {
    ...
    // Clear code state when switching questions
    useEffect(() => {
        if (currentQuestion?.type !== 'coding') return;
        // In a real app we'd load saved code from answers. 
        // For now, clear it or load if exists in answers (if implementing persistence)
        clearCode();
        ...
        <div className="h-screen flex flex-col bg-gray-50 font-sans">
            ...
            {hasShownLowTimeWarning && (
                <div className="fixed top-4 right-4 z-50 animate-slideInRight">
                    <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 shadow-lg rounded-r-lg max-w-md">
            ...
            {showTimesUpAlert && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
                    <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl transform scale-100 border-4 border-red-500 animate-bounce">
