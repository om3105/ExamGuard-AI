        ...
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                    ...
                    <div className="absolute top-[20%] -right-[10%] w-[30%] h-[30%] bg-indigo-100 rounded-full blur-[80px] opacity-40"></div>
                </div>

                <div className="relative z-10 w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    {/* Status Banner */}
                        ...
                        <div className="w-full border-t border-gray-100 pt-8 flex flex-col items-center gap-4">
                            {!canEnter ? (
                                ...
                                <button
                                    ...
                                    className="px-10 py-4 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl shadow-lg shadow-green-200 transform transition hover:-translate-y-0.5 active:translate-y-0 text-lg flex items-center gap-2 group"
                                >
